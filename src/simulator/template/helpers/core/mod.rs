...
/// Register core template helpers
pub fn register(handlebars: &mut Handlebars) {
    // Register helpers from dedicated modules
    faker::register(handlebars);
    math::register(handlebars);
    text::register(handlebars);

    // Register built-in core helpers
