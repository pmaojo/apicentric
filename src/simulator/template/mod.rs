...
/// Trait representing a template rendering engine
pub trait TemplateRenderer {
    fn render(&self, template: &str, context: &TemplateContext) -> PulseResult<String>;
}
...
impl TemplateEngine {
    ...
    pub fn new() -> PulseResult<Self> {
        ...
        Ok(Self {
            handlebars,
            preprocessor: TemplatePreprocessor::new(),
        })
    }
    ...
    pub fn render(&self, template: &str, context: &TemplateContext) -> PulseResult<String> {
        TemplateRenderer::render(self, template, context)
    }
