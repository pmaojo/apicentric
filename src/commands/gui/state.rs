...
mod service_management_tests {
    ...
    fn test_update_service_status_lifecycle() {
        ...
        assert_eq!(state.find_service("test").unwrap().status, ServiceStatus::Starting);
        
        state.update_service_status("test", ServiceStatus::Running);
        assert_eq!(state.find_service("test").unwrap().status, ServiceStatus::Running);
        
        state.update_service_status("test", ServiceStatus::Stopping);
        assert_eq!(state.find_service("test").unwrap().status, ServiceStatus::Stopping);
        
        state.update_service_status("test", ServiceStatus::Stopped);
        assert_eq!(state.find_service("test").unwrap().status, ServiceStatus::Stopped);
    }
    ...
    fn test_service_status_display_string() {
        ...
        assert_eq!(ServiceStatus::Failed("Error".to_string()).display_string(), "Failed");
    }
    ...
    fn test_service_status_error_message() {
        ...
        assert_eq!(ServiceStatus::Failed("Test error".to_string()).error_message(), Some("Test error"));
    }
