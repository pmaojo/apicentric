                ...
                <div className="space-y-2">
                  {twins.map(t => (
                    <div
                      ...
                      className={`p-2 rounded cursor-pointer hover:bg-accent focus-visible:outline-none focus-visible:bg-accent focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset ${selectedTwin === t ? 'bg-accent' : ''}`}
