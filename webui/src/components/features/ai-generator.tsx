...
export function AiGenerator({ onAddService }: AiGeneratorProps) {
  ...
  const [generatedDefinition, setGeneratedDefinition] = React.useState<
    string | null
  >(null);
  ...
  function handleApply() {
    ...
    try {
      ...
      toast({
        title: "Service Added",
        description:
          "The generated service has been added to your services list.",
      });
      ...
      toast({
        ...
        title: "Invalid YAML",
        description:
          "The generated YAML is invalid. Please review and fix errors.",
      });
    }
  }
      ...
      <div className="space-y-6">
        ...
        {showConfigGuide && (
          <Alert>
            ...
            <AlertDescription>
              <p className="mb-2">
                AI generation requires configuration. Please set up one of the
                following providers:
              </p>
              <ul className="list-disc list-inside space-y-1 text-sm">
                ...
                <li>
                  <strong>Gemini:</strong> Set <code>GEMINI_API_KEY</code>{" "}
                  environment variable
                </li>
                <li>
                  <strong>Local:</strong> Configure local LLM endpoint in
                  settings
                </li>
              </ul>
              <Button
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Use natural language to describe the API you want to create.
                Provide details about endpoints, data models, and desired
                functionality.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="flex flex-col">
            <CardHeader>
              ...
              <CardDescription>
                The AI-generated YAML definition will appear here. Review
                validation errors and apply when ready.
              </CardDescription>
            </CardHeader>
